...
(function() {
    ...
    // $.getScript('assets/js/resetThemes/rFuture.js');

    // $.getScript('assets/js/resetThemes/rLifeTheme.js');

    // $.getScript('assets/js/resetThemes/document-DC.js');

    $.getScript('assets/js/resetThemes/rMinimalTheme.js');


    // Run ScrollBar JQuery
    $.getScript('assets/js/resetThemes/scrollBar_R.js');

    $.getScript('assets/js/animationScroll.js');
