    ...
    miniLeadScreen = function() {
        varib = {
            loadVarib: function() {
                ...
                showData = $('.showData'); emailData = $('.emailData');
                clickEvent = 'click'; gridBtn = $('.grid-button'); timeSelect = $('#time'); flagBtn = $('.flagBtn');
                $alertColor = $('.alert_Call .leadAlertspan div'); $thisAlert = $('.leadId_info .alert_Call');
                userDrop = $('.userDrop'); miniProductFloor = $('#miniProductAw-Floor');
                flagTip = $('.flagTip'); flagbutton = $('.button_Flag');userDrop = $('.right-sales .userDrop'); clockDrop = $('.right-sales .clockDrop');
                clockTip = $('.clockTip');clockbutton = $('.button_Clock');source = $('.source');sourceData = $('.sourceDta'); timelock = $('.15Time, .30Time, .60Time');
                each15Tip = $('.each15');each30Tip = $('.each30'); each45Tip = $('.each45');each60Tip = $('.each60');clock15Btn = $('.15Time');clock30Btn = $('.30Time');clock45Btn = $('.45Time');
                clock60Btn = $('.60Time');sendButton = $('.sendBtn');sendTip = $('.sendMTip');userButton = $('.userBtn');
                selectUser = $('.selectUser');transferBtn = $('.transferBtn');transferTip = $('.transferTip');rejectBtn = $('.rejectBtn');rejectTip = $('.rejectTip'); retainBtn = $('.retainBtn');
                retainTip = $('.retainTip');deleteBtn = $('.deleteBtn');deleteTip = $('.deleteTip');titleTasks = $('.titleTasks');topZpart1 = $('.topZpart1');
            }
        }
