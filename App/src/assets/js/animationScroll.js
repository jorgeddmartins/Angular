...
$(function(_animScrollFunction) {
    ...
    var $slideUprollEffect = $(".slideUp");
    var $slideExpandUpEffect = $(".slideExpandUp");
    var $slideHatchEffect = $(".hatch");
    var $slideStretchRightEffect = $(".stretchRight");
    ...
    function check_scrollView() {
        ...
        $.each($slideUprollEffect, function(_slideUprollData) {
            if ((($(this).offset().top + $(this).outerHeight()) >= $checkslideUproll.scrollTop()) && ($(this).offset().top <= ($checkslideUproll.scrollTop() + $checkslideUproll.height()))) {
                $(this).addClass('slideUpEffect');
            } else {
                $(this).removeClass('slideUpEffect');
            }
        ...
        $.each($slideExpandUpEffect, function(_slideUprollData) {
            if ((($(this).offset().top + $(this).outerHeight()) >= $checkslideExpandUp.scrollTop()) && ($(this).offset().top <= ($checkslideExpandUp.scrollTop() + $checkslideExpandUp.height()))) {
                $(this).addClass('slideExpandUpEffect');
            } else {
                $(this).removeClass('slideExpandUpEffect');
            }
        });

        $.each($slideHatchEffect, function(_slideUprollData) {
            if ((($(this).offset().top + $(this).outerHeight()) >= $checkslideHatch.scrollTop()) && ($(this).offset().top <= ($checkslideHatch.scrollTop() + $checkslideHatch.height()))) {
                $(this).addClass('hatchEffect');
            } else {
                $(this).removeClass('hatchEffect');
            }
        });

        $.each($slideStretchRightEffect, function(_slideUprollData) {
            if ((($(this).offset().top + $(this).outerHeight()) >= $checkStretchRight.scrollTop()) && ($(this).offset().top <= ($checkStretchRight.scrollTop() + $checkStretchRight.height()))) {
                $(this).addClass('stretchRightEffect');
            } else {
                $(this).removeClass('stretchRightEffect');
            }
        });
